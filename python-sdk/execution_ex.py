...
pt_geom_3 = {'rot_pat':[1, None, [[-30,30], [0,0]]], 'shi_pat':[1, None, [[-1.5, 1.5], [-1.5, 1.5]]], 'pt_name':'affine_transform_map'}
...
pt_vect_3 = {'wid_lan':[1, 0.1, 1], 'pt_name':'widden_lane'}
...
mme.update_pt_version(pt_versions)
